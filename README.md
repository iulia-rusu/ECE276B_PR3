...
## Overview
In this assignment, you will implement a controller for a differential-drive car robot to track a lemniscate reference trajectory while avoiding obstacles.
